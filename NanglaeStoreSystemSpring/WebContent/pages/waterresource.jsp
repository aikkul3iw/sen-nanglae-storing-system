						...
						<li><a href="#"><i class="glyphicon glyphicon-leaf"></i>
							...
							<ul class="nav nav-second-level">
								...
								<li><a href="#">ทรัพยากรธรรมชาติ<span class="fa arrow"></span></a>
									<ul class="nav nav-third-level">
										<li><a href="waterresource.html">ทรัพยากรน้ำ</a></li>
										<li><a href="landresource.html">ทรัพยากรดิน</a></li>
										<li><a href="forrestresource.html">ทรัพยากรป่าไม้</a></li>
									</ul></li>
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<input type="hidden" name="water_id" id="water_id" value="" />
												</div>

												<div class="modal-footer">
													<button type="button" class="btn btn-default"
														data-dismiss="modal">ยกเลิก</button>
													<button type="button" id="deleteWater"
														class="btn btn-danger" onclick="deleteWater();">ลบข้อมูล</button>
